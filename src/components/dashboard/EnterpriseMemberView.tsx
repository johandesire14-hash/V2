  ...
  const ecosystemFeatures = React.useMemo(() => {
    ...
    if (tgOffer || (currentSub.telegramChannels && currentSub.telegramChannels.length > 0)) {
      items.push({
        ...
        badgeLabel: isTelegramUnlocked ? `🔓 Accessible (${authorizedTelegramChannels.length})` : "🔒 Verrouillé",
    ...
    if (dcOffer || (currentSub.discordChannels && currentSub.discordChannels.length > 0) || currentSub.discordInvite) {
      items.push({
        ...
        badgeLabel: isDiscordUnlocked ? `🔓 Accessible (${authorizedDiscordChannels.length})` : "🔒 Verrouillé",
    ...
    if (ebOffer || (currentSub.ebooks && currentSub.ebooks.length > 0)) {
      items.push({
        ...
        badgeLabel: isEbookUnlocked ? `🔓 Accessible (${authorizedEbooks.length})` : "🔒 Verrouillé",
    ...
    if (coOffer || (currentSub.courses && currentSub.courses.length > 0)) {
      items.push({
        ...
        badgeLabel: isCourseUnlocked ? `🔓 Accessible (${authorizedCourses.length})` : "🔒 Verrouillé",
                    ...
                    <div className="flex items-start sm:items-center gap-3">
                      ...
                      <div className="space-y-0.5">
                        <div className="text-xs font-bold text-white flex items-center gap-2">
                          ...
                          <span className="text-[10px] bg-blue-500/20 text-blue-300 border border-blue-500/40 px-2 py-0.5 rounded-full font-mono font-semibold">
                            Visiteur
                          </span>
                        </div>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start justify-between gap-2">
                              ...
                              >
                                {isOfferUnlocked ? "🔓 Accessible" : "🔒 Verrouillé"}
                              </span>
                            </div>
