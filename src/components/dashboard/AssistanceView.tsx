                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {conv.unreadCount > 0 && (
                          <span className="size-4 rounded-full bg-[#00D26A] text-black font-black text-[9px] flex items-center justify-center shrink-0">
                            {conv.unreadCount}
                          </span>
                        )}
                      </div>
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 bg-[#0d0e11]/70">
                ...
                <div className="flex items-center justify-center my-2">
                  <span className="text-[10px] font-mono text-zinc-500 px-3 py-1 rounded-full bg-white/[0.03] border border-white/5">
